...
#     ifmplement a function called greatest_common_divisor() that determines the greatest common divisor of two numbers.

# Example:
# [IN]: greatest_common_divisor(32,48)
# [OUT]: 16

# You just need to implement  the function. The test run deveral test cases to validate the solution.
